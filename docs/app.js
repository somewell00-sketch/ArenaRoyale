...
function renderStart(){
  root.innerHTML = `
    <div class="screen">
      <div class="card">
        <div class="h1">Survival Arena</div>
    ...
    <div class="app">
      <aside class="panel">
        <div class="row" style="justify-content:space-between;">
          <div>
            <div class="h1" style="margin:0;">${world.map?.arena?.title || "Survival Arena"}</div>
            <div class="muted small">Area Inspector • Dia: <span id="day"></span> • Seed: <span id="seed"></span></div>
          </div>
        </div>
