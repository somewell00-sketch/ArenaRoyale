...
function renderGame(){
      ...
      <aside class="panel">
        <div class="row" style="justify-content:space-between;">
          <div>
            ...
            <div class="muted small">Dia: <span id="day"></span> • Seed: <span id="seed"></span> • Arena: <span id="arenaName"></span></div>
          </div>
        </div>
  ...
  function sync(){
    ...
    arenaNameEl.textContent = String(world.map?.arenaName || "Survival Arena");
